...
let data = '<button class="open-other-popup-left">Open other popup left</button>';
...
function openTabTemplate_1(parent,data) {
    new Promise(function (resolve, reject) {
        ...
        resolve(tab);
    }).then(tab => {tab.openPopupTab();return tab});
}

function openTabTemplate_2(parent,data) {
    new Promise(function (resolve, reject) {
        let tab = new Template_1(
            {
                position: "right",
...
function openTabTemplate_3(parent,data) {
    new Promise(function (resolve, reject) {
        let tab = new Template_1(
            {
                position: "top",
...
function openTabGallery(parent,data) {
    new Promise(function (resolve, reject) {
        let tab = new Gallery(
            {
                position: "center",
